...
class RoomTypesControllerTest < ActionController::TestCase
  ...
  test "should create room_type" do
    assert_difference('RoomType.count') do
      post :create, room_type: { brief_description: @room_type.brief_description, description: @room_type.description, name: @room_type.name }
    end
  ...
  test "should update room_type" do
    put :update, id: @room_type, room_type: { brief_description: @room_type.brief_description, description: @room_type.description, name: @room_type.name }
    assert_redirected_to room_type_path(assigns(:room_type))
  end
