...
Controlador de sesiones, el de la vista pública si es que es necesario...
**** TODO controlador de sesiones
rails g controller session new destroy
*** TODO aplicar estilos de bootstrap a los scaffolds
Solo los modelos que tienen vistas
*** TODO integrar bcrypt y password encriptado en base de datos
