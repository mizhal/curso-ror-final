...
**** TODO  Envía correo a los administradores (en la operación create)
*** TODO controlador de contacto
...
Ver lo que conviene. 
En principio, anidar las fotos con el alojamiento (independientemente de si sean de la)
