...
***** TODO añadir gema paperclip
***** TODO rehacer scaffold de photo
Copiar el contenido del modelo y rehacerlo todo y luego volver a copiar al nuevo modelo
***** TODO crear migraciones y attachment de paperclip en modelo de photo
***** TODO colocar subformulario estático en Accommodation#_form
