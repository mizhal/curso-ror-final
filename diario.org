...
*** TODO widget de gestion de alojamientos
Debe mostrar botones para editar, borrar, crear habitaciones, añadir fotos y añadir ofertas
*** TODO generar scaffold de Config
Un objeto global de configuracion
*** FOCUS definir fotos por defecto 
*** FOCUS partial de oferta vinculada
...
**** TODO corregir navegador de tipologias
...
*** TODO estilo de la vista pública de ofertas
*** TODO layout público
